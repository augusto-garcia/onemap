...
##' \code{"intercross"} for an F2 progeny; \code{"backcross"}; \code{"riself"}
##' for recombinant inbred lines by self-mating; or \code{"risib"} for recombinant
##' inbred lines by sib-mating.
...
vcf2raw <- function(input = NULL, output = NULL,
                    cross = c("outcross", "intercross", "backcross", "riself", "risib"),
