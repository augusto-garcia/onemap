...
##'  draw_map2(seq1,seq2,seq3,tag = c("M1","M2","M3","M4","M5"),output = paste0(tempfile(), ".png"))
##'  
...
##'  )
##'  draw_map2(seq,tag = "all",group.names = c("Chr 1","Chr 2","Chr 3"),main="Linkage Map", output = paste0(tempfile(), ".png"))
##'
##' }
##'@export
