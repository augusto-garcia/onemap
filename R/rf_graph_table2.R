...
## Package: onemap                                                     ##
##                                                                     ##
## File: rf_graph_table2.R                                             ##
## Contains: rf_graph_table2                                           ##
##                                                                     ##
...
##' @param lab.xy logical. If \code{TRUE}, displays axis labs (x and y).
...
##'   LG1.rcd <- rcd(LG1)
##'   rf_graph_table2(LG1.rcd, inter=FALSE)
##'
##' 
##'   ##Now, using interactive plotly
##'   rf_graph_table2(LG1.rcd, inter=TRUE)
##'
##'   ##F2 example
...
##'   require(gridExtra)
##'   plot1 <- rf_graph_table2(maps.list[[1]], main="Group 1",inter=FALSE)
##'   plot2 <- rf_graph_table2(maps.list[[2]], main="Group 2",inter=FALSE)
##'   plot3 <- rf_graph_table2(maps.list[[3]], main="Group 3",inter=FALSE)
##'   grid.arrange(plot1, plot2, plot3, nrow=3)
##'
##'   ##Save interactive/HTML plot
##'   p <- rf_graph_table2(LG1.rcd)
##'   htmlwidgets::saveWidget(p, "LG1_rcd.html")
##' }
##'

rf_graph_table2 <- function(input.seq,
                             graph.LOD=FALSE,
                             main=NULL,
                             inter=TRUE,
                             mrk.names=TRUE,
                             ...
                             n.colors=4){
    ## WARNING ##
    print("Warning: This function is in beta test. Let us know if you face any problem with it!")
