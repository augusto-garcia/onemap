...
Here we want to compare the best map using updog counts simulations and updog, polyrad and supermassa genotyping and genotypes probabilities. As a simple example, we will simulate only five families and one chromosome.
...
for(depth in c(100, 50, 10)){
  ...
  rf_graph_table(map_real, main = paste0("Real"))
  ...
  onemap_0.05 <- create_probs(onemap_out.obj, global_error = 0.05)
