...
pedsim2vcf(inputfile = "sim_out_genotypes.dat", 
           ...
           p.mean.depth = 100, 
           chr.mb = 10, 
           method = "neg.binom", #updog ta com pau
           mean.phred = 20)

vcfR.obj <- read.vcfR("simu.vcf")
onemap.obj <- onemap_read_vcfR(vcfR.object = vcfR.obj, cross = "outcross", parent1 = "P1", parent2 = "P2")
```
