...
After, you can use `onemap_read_vcfR` function to convert this object to `onemap` object. The parameters used are the `vcfR.object` (which just created), the identification of each parent (here you must define only one sample for each parent) and the cross type.
...
There are a inversion between markers `SNP17` and `SNP18` and the marker `M29` was removed in te second strategy.
...
There are a inversion between markers `SNP17` and `SNP18` and the marker `M29` was removed in the second strategy.
...
**Warning**: By now, only available for Unix-like operational systems
...
|:----------|---------------------------:|------------------------:|
|rcd        |                    2.687657|                0.6150103|
|record     |                    2.742556|                0.7189469|
|ug         |                    1.544829|                0.4939636|
|mds_onemap |                    1.363906|                0.5241453|
|map        |                    2.243384|                0.7256800|
...
<img src="out_img/plot.simParallel.jpg" width="400" height="400">
...
<img src="out_img/plot.segre.jpg" width="400" height="400">
...
<img src="out_img/rds.jpg" width="500" height="400">
...
<img src="out_img/up.jpg" width="500" height="400">
