...
vignette: >
  %\VignetteIndexEntry{Outcrosssing Populations}
...
`example_out.raw` (available in `extdata` with `OneMap` and saved in the directory
...
* first: `example_out` with 30 markers and 100 individuals
...
fraction between all pairs of markers, using two-point tests.  At this point, you should pay no attention if
