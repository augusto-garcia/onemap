...
## ----, chi_square--------------------------------------------------------
f2.test <- test.segregation(fake.f2.onemap)
...
## ----, Bonferroni--------------------------------------------------------
Bonferroni.alpha(f2.test)

## ----, plot_chisq--------------------------------------------------------
plot(f2.test)

## ----, select_nondistorted-----------------------------------------------
(non.dist <- subset.chisq(f2.test))

## ----, select_distorted--------------------------------------------------
(distorted <- subset.chisq(f2.test, distorted=TRUE))

## ----, two_point_tests, results="hide"-----------------------------------
twopts.f2 <- rf.2pts(fake.f2.onemap)

## ----, Suggest_LOD-------------------------------------------------------
suggest.lod(fake.f2.onemap)
