...
*NOTE*: Results are not plotted in this vignette, please check the vignette in [GitHub version](https://statgen-esalq.github.io/tutorials/onemap/Inbred_Based_Populations.html).
...
```{r, ripple_lg2_final, results="hide", eval=FALSE}
...
LG2_f2_ord <- order_seq(input.seq = LG2_ug_f2, n.init = 5,
                        subset.search = "twopt",
                        twopt.alg = "rcd", THRES = 3,
                        touchdown = FALSE, rm_unlinked = TRUE)
``` 
...
*NOTE*: Results in this session are not plotted in this vignette, please check the vignette in [GitHub version](https://statgen-esalq.github.io/tutorials/onemap/Inbred_Based_Populations.html).

Automatic usage of try algorithm.

```{r, order_LG3, results='hide', eval=FALSE}
...
```{r, ripple_LG3, results="hide", eval=FALSE}
...
```{r}
maps_list <- list(LG1_f2_final, LG2_f2_final)
```
