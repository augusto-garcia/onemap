...
You can then assign markers to linkage groups using the function
`group`:
...
suggested by `suggest.lod` (rounded up):
...
just to avoiding type the object `LGs.f2` to have it printed).
