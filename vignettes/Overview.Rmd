...
computing ([www.r-project.org](www.r-project.org)). It is designed to
...
different marker types containing various segregation patterns. Also,
it allows the simultaneous estimation of linkage and linkage phases
...
al., 2013), rubber tree (Souza et al., 2013) and Acca sellowiana
...
difference is that, for the later, there is no need to estimate
linkage phases.
...
ordination algorithms. Version 1.0-0 had Rapid Chain Delineation - RCD
...
start using _OneMap_. People with some knowledge of R could just skip
this part.

We also wrote a chapter with information about _OneMap_ installation,
as well as sections showing the usage of _OneMap_ building linkage
maps for outcrossing (non-inbred) populations, as well as F$_2$
populations (which can also be applied to backcrosses and RILs).

All sections could be read independently. So, you can just move to the
part you are interested. So, good luck, and let us know if you have
