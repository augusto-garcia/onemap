...
As described in the `vcfR` package vignette, RAM memory use is an important consideration when using `vcfR`. Depending of your dataset, the object created can be huge and occupy a lot of memory.
...
with the smallest one, which is linkage group 3 (considering `group` function). This can be easily
