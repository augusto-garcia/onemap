...
*NOTE*: Check the [GitHub vignette version](https://statgen-esalq.github.io/tutorials/onemap/Outcrossing_Populations.html) to visualize the results of this session.
...
```{r, width = 9.5, height = 9.5, eval=FALSE}
